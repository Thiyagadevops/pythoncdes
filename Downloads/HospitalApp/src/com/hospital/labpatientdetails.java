...
public class labpatientdetails extends Activity {
	String[] sex =
	{
		"Male","Female",
	};
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     sexspin.setOnItemSelectedListener(new newOnItemSelectedListener());
     btcancel.setOnClickListener(new View.OnClickListener() 
     {
		...
		public void onClick(View v) {
			...
			Intent i=new Intent(labpatientdetails.this,phylabdetail.class);
			i.putExtra("lab",lab);
	...
	btok.setOnClickListener(new View.OnClickListener() 
{
	...
	public void onClick(View v) 
	{
		...
		String sspin = newOnItemSelectedListener.s;
	...
	db.close();
	Toast.makeText(labpatientdetails.this, "Data Entered successfully",Toast.LENGTH_LONG).show();
	Intent i=new Intent(labpatientdetails.this,phylabdetail.class);
	i.putExtra("lab",lab);
	i.putExtra("trust",user);
	startActivity(i);
		...
		{	
			Toast.makeText(labpatientdetails.this, "Fill all the details",Toast.LENGTH_LONG).show();
		}	
	}
});
    }
	
	public static class newOnItemSelectedListener implements OnItemSelectedListener
		    {
			static String s;
