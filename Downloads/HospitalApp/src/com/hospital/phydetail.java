...
public class phydetail extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
	  ...
	  //  nurse=bundle.getString("nur");
	 //   labt=bundle.getString("lab");
	  //  chief=bundle.getString("cdoc");
		DBHelper.open();
		fetchdata();
		DBHelper.close();
	...
	private void setPatientButtonClickListener() {
		addPatient.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(phydetail.this, patientdetails.class);
				i.putExtra("phy",phy);
	...
	private void setButtonClickListener() {
		...
		imgback.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i = new Intent(phydetail.this,EmployeeList.class);
				i.putExtra("trust",user);
				startActivity(i);
			}	
		});
	...
	private void fetchdata() {
		...
		Cursor c = DBHelper.getpatientfordoctor(phy);
		if (c.moveToFirst()) {
			do {
		...
		/*Cursor cur = DBHelper.getpatientfornurse(nurse);
		if (cur.moveToFirst()) {
			do {
				
				list.add(cur.getString(cur.getColumnIndex("patientname")));
				list1.add(cur.getString(cur.getColumnIndex("sex")));
				list2.add(cur.getString(cur.getColumnIndex("diseasename")));
		...
		patientList.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			DBHelper.close();
			Intent i = new Intent(phydetail.this, editPatient.class);
        ...
        patientList.setOnItemClickListener(new OnItemClickListener() 
		{
					...
					long id) 
			{
				...
				if (c.moveToFirst()) {
					...
					Intent i = new Intent(phydetail.this, patientView.class);
					Bundle bundle = new Bundle();
