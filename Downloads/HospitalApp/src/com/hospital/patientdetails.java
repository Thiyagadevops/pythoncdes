    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     btcancel.setOnClickListener(new View.OnClickListener() 
     {
		...
		public void onClick(View v) {
			...
			Intent i=new Intent(patientdetails.this,phydetail.class);
			i.putExtra("phy",phy);
	...
	btok.setOnClickListener(new View.OnClickListener() 
{
	...
	db.close();
	Toast.makeText(patientdetails.this, "Data Entered successfully",Toast.LENGTH_LONG).show();
	Intent i=new Intent(patientdetails.this,phydetail.class);
	i.putExtra("phy",phy);
	i.putExtra("trust",user);
	startActivity(i);
		...
		{	
			Toast.makeText(patientdetails.this, "Fill all the details",Toast.LENGTH_LONG).show();
		}	
	}
});
    }
