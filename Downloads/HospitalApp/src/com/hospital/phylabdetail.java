...
public class phylabdetail extends Activity {
	...
	private void setPatientButtonClickListener() {
		addPatient.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(phylabdetail.this, labpatientdetails.class);
				i.putExtra("lab",lab);
	...
	private void setButtonClickListener() {
		...
		imgback.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i = new Intent(phylabdetail.this,EmployeeList.class);
				i.putExtra("trust",user);
				startActivity(i);
			}	
		});
	...
	private void fetchdata() {
        ...
        Cursor c = DBHelper.getpatientforlab(lab);
		if (c.moveToFirst()) {
			do {
		...
		patientList.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			DBHelper.close();
			Intent i = new Intent(phylabdetail.this, labedit.class);
        ...
        patientList.setOnItemClickListener(new OnItemClickListener() 
		{
					...
					long id) 
			{
				...
				if (c.moveToFirst()) {
					...
					Intent i = new Intent(phylabdetail.this, labView.class);
					Bundle bundle = new Bundle();
