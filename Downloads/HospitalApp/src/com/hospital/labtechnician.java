...
public class labtechnician extends Activity {
	...
	private void setButtonClickListener() {
		...
		image.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent i = new Intent(labtechnician.this,EmployeeList.class);
	...
	private void fetchdata() {
		...
		Cursor c = DBHelper.getAlllabtech();
		if (c.moveToFirst()) 
		{
			do {

				list.add(c.getString(c.getColumnIndex("labtechname")));
				list1.add(c.getString(c.getColumnIndex("designation")));
							...
							if (c.moveToFirst()) 
						     {
								do {
								      ...
								      if(trust>=3)
								      {
								          Intent i = new Intent(labtechnician.this, phylabdetail.class);
										  i.putExtra("lab",o.toString());
