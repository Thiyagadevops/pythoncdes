...
public class chiefpatientdetails extends Activity {
	String[] sex =
	{
		"Male","Female",
	};
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     btcancel.setOnClickListener(new View.OnClickListener() 
     {
		...
		public void onClick(View v) {
			...
			Intent i=new Intent(chiefpatientdetails.this,phychiefdetail.class);
	...
	btok.setOnClickListener(new View.OnClickListener() 
{
	...
	db.close();
	Toast.makeText(chiefpatientdetails.this, "Data Entered successfully",Toast.LENGTH_LONG).show();
	Intent i=new Intent(chiefpatientdetails.this,phychiefdetail.class);
	i.putExtra("chief",chief);
	i.putExtra("trust",user);
	startActivity(i);
		...
		{	
			Toast.makeText(chiefpatientdetails.this, "Fill all the details",Toast.LENGTH_LONG).show();
		}	
	}
});
    }
