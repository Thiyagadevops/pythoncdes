...
public class nursedetail extends Activity {
	...
	private void setButtonClickListener() {
		...
		image.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent i = new Intent(nursedetail.this,EmployeeList.class);
							...
							if (c.moveToFirst()) 
						     {
								do {
								      ...
								      if(trust>=3)
								      {
								          Intent i = new Intent(nursedetail.this, phynursedetail.class);
										  i.putExtra("nurse",o.toString());
